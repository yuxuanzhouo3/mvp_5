  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="w-full min-h-screen">
        <header className="relative z-30 bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 px-3 sm:px-5 py-3 sm:py-4">
          <div className="flex flex-col gap-3 sm:gap-4 lg:flex-row lg:items-center">
            <div className="min-w-0 w-full flex-1">
              <div className="flex min-w-0 flex-col items-start gap-2.5 sm:flex-row sm:flex-wrap sm:items-center">
                <h1 className="min-w-0 w-full max-w-full text-[clamp(1.2rem,8vw,1.75rem)] font-bold leading-[1.15] text-gray-900 dark:text-white break-all sm:text-[1.9rem] sm:break-words lg:text-3xl lg:truncate">
            ...
            <div className="flex w-full flex-wrap items-center justify-end gap-1.5 sm:gap-2 lg:ml-auto lg:w-auto shrink-0">
              ...
              {user && (
                <button
                  ...
                  className="flex items-center justify-center bg-blue-500 hover:bg-blue-600 text-white border border-blue-500 h-8 w-8 sm:h-8 sm:w-auto rounded-md px-0 sm:px-2 transition-colors"
        ...
        <div className="flex flex-col items-center justify-center px-4 pt-8 pb-4">
          <h2 className="text-5xl sm:text-6xl font-bold text-gray-900 dark:text-white mb-2">
            {appDisplayName || text.appName}
          </h2>
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
            {currentLanguage === "zh" ? "用AI编辑和转换您的内容" : "Edit and transform your content with AI"}
          </p>
        </div>

        {/* Main Content - Centered Single Column */}
        <main className="max-w-4xl mx-auto w-full px-4 sm:px-6 space-y-6 pb-12">
          ...
          <div className="w-full">
            <Collapse title={currentLanguage === "zh" ? "生成记录" : "Generation History"} defaultOpen={false}>
              <div className="max-h-[60vh] overflow-y-auto scrollbar-visible">
                <OperationsDashboard
