...
const AIOperations: React.FC<AIOperationsProps> = ({
  ...
  return (
    <section className="rounded-lg bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700 p-4 sm:p-6 h-full min-h-0 overflow-hidden flex flex-col">
      ...
      <button
        ...
        className="mt-4 sm:mt-5 w-full shrink-0 h-12 sm:h-11 rounded-lg bg-blue-500 hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold transition-colors flex items-center justify-center gap-2"
      >
        {isGenerating && (
